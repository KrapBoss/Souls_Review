...
namespace CustomUI
{
    public class Semi_StaticUI : MonoBehaviour
    {
        ...
        [Space]
        [Header("알림 리스트")]
        [SerializeField] GameObject go_NoticeList;
        ...
        private void Start()
        {
            ...
            //if(go_NoticeList.activeSelf) { ShowNoticeList(); }
        }
        ...
        /// <summary> 지금까지 보인 알림창들을 보여줄 UI를 활성화합니다. </summary>
        public void ShowNoticeList() { go_NoticeList.SetActive(!go_NoticeList.activeSelf); }
    }
}