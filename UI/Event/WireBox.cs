...
public class WireBox : MonoBehaviour
{
    ...
    void RandomBoundary()
    {
        ...
        float x = ((rect_GageParent.rect.width * .4f) + offsetBoundary) * Mathf.Cos(Mathf.Deg2Rad * _dotAngle) + Screen.width * 0.5f;
        float y = ((rect_GageParent.rect.height * .4f) + offsetBoundary) * Mathf.Sin(Mathf.Deg2Rad * _dotAngle) + Screen.height * 0.5f;
    ...
    void DotRotate()
    {
        ...
        float x = ((rect_GageParent.rect.width * 0.4f) + offsetBoundary) * Mathf.Cos(Mathf.Deg2Rad * _dotAngle) + Screen.width * 0.5f;
        float y = ((rect_GageParent.rect.height * 0.4f) + offsetBoundary) * Mathf.Sin(Mathf.Deg2Rad * _dotAngle) + Screen.height * 0.5f;
        img_dot.rectTransform.position = new Vector3(x, y, 0);
    }
