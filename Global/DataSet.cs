...
public class DataSet
{
    ...
    DataSet()
    {
        ...
        Color_Default = new Color((18+5) / 255.0f, (33+5) / 255.0f, (55+5) / 255.0f);
        //Color_Default = new Color(44/255.0f, 44 / 255.0f, 44 / 255.0f);
    ...
    public Color GetDefaultColor() { return Color_Default * GraphicSetValue.Brightness * (GameConfig.IsPc() ? 1 : 1.5f) ; }
    ...
    //기본 환경 색상
    public Color Color_Default; // 기본 밤
    public Color Color_Camera;  // 야간 카메라
    public Color Color_Evening; //저녁
}
