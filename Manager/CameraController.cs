...
public class CameraController : MonoBehaviour
{
        ...
        if (!PlayerEvent.instance.showVideo)
        {
            ...
            switch (number)
            {
                ...
                case VideoType.MUSICBOX: //Box
                    ...
                    break;
                case VideoType.WHITEGHOST: //하얀 영혼 설명
                    txt = LocalLanguageSetting.Instance.GetLocalText("Tip", "WhiteGhost");
                    break;
                default:
    ...
    public void FlashLight(bool active)
    {
        ...
        PlayerEvent.instance.flashLight = go_FlashLight.activeSelf;
    }
}
