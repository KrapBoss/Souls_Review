...
public class GetItemUse : ExpandObject
{
    ...
    void ItemActive()
    {
        ...
        if (mCamera) // 카메라 오브젝트일 경우
        {
            VoiceLineManager.Instance.EnterLine(new() { clip = "chals_paint1", delay = 0, line = "chals_paint1", reverb = true });
            VoiceLineManager.Instance.EnterLine(new() { clip = "chals_paint2", delay = 0, line = "chals_paint2", reverb = true });
            VoiceLineManager.Instance.EnterLine(new() { clip = "chals_paint3", delay = 0, line = "chals_paint3", reverb = true });
            VoiceLineManager.Instance.EnterLine(new() { clip = "chals_paint4", delay = 0, line = "chals_paint4", reverb = true });
            VoiceLineManager.Instance.EnterLine(new() { clip = "H_TutorialPaint2", delay = 1, line = "H_TutorialPaint2", reverb = false });
