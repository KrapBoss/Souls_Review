...
public class Obj_WireBox : ExpandObject
{
    ...
    void Success(bool success)
    {
        if(success)
        {
            ...
            source.clip = clip_Success;
            source.volume = DataSet.Instance.SettingValue.Volume * 1.2f;
            source.loop = false;
            source.Play();
        ...
        {
            //파직 사운드
            source.PlayOneShot(clip_Failed, DataSet.Instance.SettingValue.Volume * 1.5f);
