...
public class Outro : MonoBehaviour
{
    ...
    IEnumerator OutroCoutine(Action endAction)
    {
        ...
        VoiceLineManager.Instance.EnterLine(new() { clip = $"C_Outro1", delay = 0, line = $"C_Outro1", reverb = true });
        VoiceLineManager.Instance.EnterLine(new() { clip = $"D_Outro1", delay = 0, line = $"D_Outro1", reverb = true });
        ...
        VoiceLineManager.Instance.EnterLine(new() { clip = $"C_Outro2", delay = 0, line = $"C_Outro2", reverb = true });
        ...
        VoiceLineManager.Instance.EnterLine(new() { clip = $"D_Outro2", delay = 0, line = $"D_Outro2", reverb = true });
        VoiceLineManager.Instance.ShowLine(false);
        ...
        //UI.staticUI.ShowLine();
        VoiceLineManager.Instance.EnterLine(new() { clip = key, delay = 0, line = key, reverb = false }, nonTranslate: false);
