...
public class Step9 : ExpandObject
{
    ...
    IEnumerator ActionCroutine()
    {
        ...
        //대사 : 하아... 인생 ㅆ.....
        UI.staticUI.EnterLine(LocalLanguageSetting.Instance.GetLocalText("Main", "Intro9_Line"), 4);
        ...
        UI.staticUI.EnterLine(LocalLanguageSetting.Instance.GetLocalText("Main", "Intro9-1_Line"), 4);
        UI.staticUI.ShowLine();
